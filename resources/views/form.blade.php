      ...
      <form action="/biodata" method="post">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="Text" class="form-control" id="exampleInputName" placeholder="Nama" name="Nama">
          </div>
          <div class="form-group">
            <label for="exampleInputNim">Nim</label>
            <input type="Text" class="form-control" id="exampleInputNim" placeholder="Nim" name="Nim">
          </div>
          <div class="form-group">
            <label for="exampleInputProdi">Prodi</label>
            <input type="Text" class="form-control" id="exampleInputProdi" placeholder="Prodi"name="Prodi">
          </div>
          <div class="form-group">
            <label for="exampleInputJurusan">Jurusan</label>
            <input type="Text" class="form-control" id="exampleInputJurusan" placeholder="Jurusan"name="Jurusan">
          </div>
